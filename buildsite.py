...
def create_post(title):
    ...
    print ("Content file created. You can edit directly at: %s. Use <publish> with buildsite to publish all posts" % ("contents/" + title.lower().replace(" ", "_") + ".html"))
...
if __name__ == '__main__':
    if len(sys.argv) < 2:
        print ("Usage: python buildsite.py <init/new/publish>")
        sys.exit(0)
    else:
        command = sys.argv[1]
        ga_code = '0'
